              ...
              <div className='card col-md-6 offset-md-3 offset-md-3'>
                  ...
                  <div className='card-body'>
                    <form>
                      ...
                      <button className='btn btn-success' onClick={this.updateEmployee} style={{margin:'10px'}}>Save</button>
                      <button className='btn btn-danger' onClick={this.cancel.bind(this)} style={{margin:'10px'}} >Cacel</button>
                    </form>
                  </div>
              </div>
            </div>  
